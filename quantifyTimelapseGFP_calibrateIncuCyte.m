...
function pointTable = quantifyTimelapseGFP_calibrateIncuCyte(pointTableFile,fileTableFile,outputFile,thumbnailFolder)
...
for i = 1:height(gfpFiles)
    ...
    blur = imgaussfilt(gfpImage,50);
    gfpImage = gfpImage-blur;
